...
public:
	...
	static void mult_unigram(int size, doublevector * x, CSparseMatrix &SparseMatrix, doublevector * y, int is_transposed = 0);

	static void mult_bigram(int size, doublevector * x, CSparseMatrix &SparseMatrix, doublevector * y, int is_transposed = 0);
};
